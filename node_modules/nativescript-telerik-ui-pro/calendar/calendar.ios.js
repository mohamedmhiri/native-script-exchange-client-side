        ...
        if (viewModeStyle instanceof CalendarMonthViewStyle && (cell.state & 16 /* Selected */) !== 0) {
            ...
            switch (typedStyle.selectionShape.toLowerCase()) {
                case commonModule.SelectionShape.Round.toLowerCase():
                    cell.style().shape = TKPredefinedShape.shapeWithTypeAndSize(2 /* Circle */, new CGSize({ width: 6.0, height: 6.0 }));
                    break;
                case commonModule.SelectionShape.Square.toLowerCase():
                    cell.style().shape = TKPredefinedShape.shapeWithTypeAndSize(1 /* Square */, new CGSize({ width: 6.0, height: 6.0 }));
                    break;
                case commonModule.SelectionShape.None.toLowerCase():
                    cell.style().shape = TKPredefinedShape.shapeWithTypeAndSize(0 /* None */, new CGSize({ width: 6.0, height: 6.0 }));
                    break;
            }
        }
